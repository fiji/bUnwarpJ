...
{ /* begin class bUnwarpJ_ */
    		...
    		final String targetTitle )
    {
		...
		// compose them and save the result into file
		MiscTools.composeRawTransforms( rawTransfPath1, rawTransfPath2,
				outputRawTransfPath, targetImp );
    }
    /**
    ...
    {
    	MiscTools.adaptCoefficients(inputTransfPath,
    			Double.parseDouble( strImageFactor ), outputTransfPath );
    }
    /**
    		...
    		final String targetTitle )
    {
    	...
    	MiscTools.invertRawTransformation( inputTransfPath, outputTransfPath,
    			targetImp );
    }
    /**
